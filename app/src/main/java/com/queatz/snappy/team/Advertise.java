...
import com.queatz.snappy.AdvertiseBroadcastReciever;
...
public class Advertise {
    ...
    public void hidePerson(String deviceAddress) {
    ...
    private void advertise() {
        ...
        characteristic.setValue(team.auth.getUser());
        ...
        mBluetoothAdapter.getBluetoothLeAdvertiser().startAdvertising(advertiseSettings, advertiseData, mAdvertiseCallback);
    ...
    private void showNotification(BlePerson blePerson) {
        ...
        deleteIntent = new Intent(team.context, AdvertiseBroadcastReciever.class);
